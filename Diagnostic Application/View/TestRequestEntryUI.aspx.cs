...
namespace Diagnostic_Application.View {
    public partial class TestRequestEntryUI : System.Web.UI.Page
    {
        ...
        public bool IsMobileNoExists(string chckMobileNo)
        {

            SqlConnection connection = new SqlConnection(connectionString);

            // Insert Query
            string query = "SELECT * FROM Patient WHERE mobile='" + chckMobileNo + "'";
        ...
        protected void AddButton_Click(object sender, EventArgs e){
            ...
            else if (IsMobileNoExists(MobileNoTextBox.Text))
            {
                DisplayInfoMessage("Mobile No already exists.", Color.Crimson);
                return;
            }
            else
            {
        ...
        private void CreatePdf() {
            ...
            string moduleName = "                                                          Tests and Bill Report";
            pdfDocument.Open();
            ...
            Response.AppendHeader("content-disposition", "attachment;filename=TestsBillReport.pdf");
        ...
        protected void SaveButton_Click(object sender, EventArgs e){
            ...
            {
                InfoMessageLabel.Text = "Add Some test.";
            }
