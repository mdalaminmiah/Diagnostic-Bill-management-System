...
<asp:Content ID="contentTestTypeSetup" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <form id="TestSetupUI" class="form-horizontal" runat="server">
        <h3 class=" ">Test Type Setup</h3>
        <asp:Label ID="InfoMessageLabel" CssClass=" " runat="server" Visible="false" Text=""></asp:Label>
        <div class="col-lg-8">
            <!-- type setup -->
            <div class=" ">
        ...
        <asp:GridView ID="TestSetupGridView" CssClass="table table-bordered  " runat="server" AutoGenerateColumns="False" AllowPaging="True">
            <Columns>
